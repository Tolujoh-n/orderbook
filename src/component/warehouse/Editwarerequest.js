  ...
  return (
    <>
      <div className="pagetitle">
        <h1>Edit Product Request to supplier</h1>
        <nav>
          <ol className="breadcrumb">
            <li className="breadcrumb-item">
              <a href="/">Home</a>
            </li>
            <li className="breadcrumb-item active">Edit Request</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="card p-4">
          <form onSubmit={handleSubmit}>
            <div className="row gy-4">
              <div className="col-md-6">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={productDetails.supplierAddress}
                    onChange={(e) =>
                      setProductDetails({
                        ...productDetails,
              ...
              <div className="col-md-12">
                <div className="form-group">
                  <label htmlFor="pickupAddress">Address to drop Product</label>
                  <input
                    type="text"
                    className="form-control"
                    id="pickupAddress"
...
export default Editwarerequest;
